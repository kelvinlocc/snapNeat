 ...
 * {@link RestaurantsMapFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RestaurantsMapFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RestaurantsMapFragment extends BaseFragment {
    ...
    public static RestaurantsMapFragment newInstance(String param1, String param2) {
                                                                ...
                                                                for (Restaurant restaurant : restaurants.getResults()) {
                                                                    if (restaurant.getName() != null) {
                                                                        ...
                                                                        if (restaurant.getLatitude() == mark.getPosition().latitude
                                                                            ...
                                                                            if(mListener != null)
                                                                                mListener.goBackResto(restaurant);
...
//                                                                                  for (Restaurant restaurant : restaurants.getResults()) {
//                                                                                      if (restaurant.getName() != null) {
//                                                                                          if (restaurant.getLatitude() == marker.getPosition().latitude
//                                                                                                  && restaurant.getLongitude() == marker.getPosition().longitude) {
//
//                                                                                              getActivity().getSupportFragmentManager().popBackStack();
//                                                                                              mListener.goBackResto(restaurant);
//
