...
//            v.setRotation(0);
            ...
            move(v, index, 0);
            v.setRotation(myrotation[index%4]);
        }
    }
    ...
    public void discard(int direction,final AnimatorListener al){
        ...
        discardAnim.setDuration(mDuration);
        ...
        for(int i = 0; i< mCardCollection.size();i++){
            ...
            layoutAnim.setDuration(mDuration);
    ...
    public void reverse(MotionEvent e1, MotionEvent e2){
        ...
        rotationAnim.setDuration(mDuration);
